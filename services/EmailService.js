...
<style>
  ...
  .highlight.amber{background:#fffbeb;border-color:#f59e0b;color:#92400e}
  .ftr{background:#f8fafc;padding:20px 36px;border-top:1px solid #e5e7eb;text-align:center;color:#9ca3af;font-size:12px}
  strong{color:#1e293b}
</style>
